...
function getCpuPart() {
    ...
    throw new errors_1.RhinoRuntimeError(`Unsupported CPU.`);
}
function getLinuxPlatform() {
    ...
    switch (cpuPart) {
        ...
        default:
            throw new errors_1.RhinoRuntimeError(`Unsupported CPU: '${cpuPart}'`);
    }
}
...
function getSystemLibraryPath() {
            ...
            case SYSTEM_LINUX: {
                if (arch === X86_64) {
                    ...
                    if (linuxMachine !== null) {
                        ...
                        throw new errors_1.RhinoRuntimeError(`System ${system}/${arch} is not supported by this library for this CPU.`);
                    }
                }
            }
            case SYSTEM_WINDOWS: {
    ...
    throw new errors_1.RhinoRuntimeError(`System ${system}/${arch} is not supported by this library.`);
}
