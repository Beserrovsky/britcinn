...
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_MAC}/${X86_64}`, `${PLATFORM_MAC}/x86_64/pv_rhino.node`);
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_MAC}/${ARM_64}`, `${PLATFORM_MAC}/arm64/pv_rhino.node`);
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_LINUX}/${X86_64}`, `${PLATFORM_LINUX}/x86_64/pv_rhino.node`);
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_LINUX}/${ARM_CPU_CORTEX_A7}`, `${PLATFORM_RASPBERRY_PI}/${ARM_CPU_CORTEX_A7}/pv_rhino.node`);
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_LINUX}/${ARM_CPU_CORTEX_A53}`, `${PLATFORM_RASPBERRY_PI}/${ARM_CPU_CORTEX_A53}/pv_rhino.node`);
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_LINUX}/${ARM_CPU_CORTEX_A53}${ARM_CPU_64}`, `${PLATFORM_RASPBERRY_PI}/${ARM_CPU_CORTEX_A53}${ARM_CPU_64}/pv_rhino.node`);
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_LINUX}/${ARM_CPU_CORTEX_A72}`, `${PLATFORM_RASPBERRY_PI}/${ARM_CPU_CORTEX_A72}/pv_rhino.node`);
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_LINUX}/${ARM_CPU_CORTEX_A72}${ARM_CPU_64}`, `${PLATFORM_RASPBERRY_PI}/${ARM_CPU_CORTEX_A72}${ARM_CPU_64}/pv_rhino.node`);
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_LINUX}/${ARM_CPU_CORTEX_A57}${ARM_CPU_64}`, `${PLATFORM_JETSON}/${ARM_CPU_CORTEX_A57}${ARM_CPU_64}/pv_rhino.node`);
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_LINUX}/${PLATFORM_BEAGLEBONE}`, `${PLATFORM_BEAGLEBONE}/pv_rhino.node`);
SYSTEM_TO_LIBRARY_PATH.set(`${SYSTEM_WINDOWS}/${X86_64}`, `${PLATFORM_WINDOWS}/amd64/pv_rhino.node`);
...
function getCpuPart() {
    ...
    throw new errors_1.PicovoiceRuntimeError(`Unsupported CPU.`);
}
function getLinuxPlatform() {
    ...
    switch (cpuPart) {
        ...
        default:
            throw new errors_1.PicovoiceRuntimeError(`Unsupported CPU: '${cpuPart}'`);
    }
}
...
function getSystemLibraryPath() {
            ...
            case SYSTEM_LINUX: {
                if (arch === X86_64) {
                    ...
                    if (linuxMachine !== null) {
                        ...
                        throw new errors_1.PicovoiceRuntimeError(`System ${system}/${arch} is not supported by this library for this CPU.`);
                    }
                }
            }
            case SYSTEM_WINDOWS: {
    ...
    throw new errors_1.PicovoiceRuntimeError(`System ${system}/${arch} is not supported by this library.`);
}
